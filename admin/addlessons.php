...
<body>
    ...
    <?php
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['lessonSubmitBtn'])) {
                ...
                $link_directory = '../lessonvid/' . $lesson_link;
                move_uploaded_file($lesson_link_temp, $link_directory);
                $sql = "INSERT INTO `lessons`(`lesson_name`, `lesson_desc`, `lesson_link`, `course_id`, `course_name`) VALUES ('$lesson_name','$lesson_desc','$link_directory','$c_id','$c_name')";
                if (mysqli_query($conn, $sql) == true) {
                    // Confirrming that my form is submited perfectly
                    ...
                    // if there is some problem in my form
                    $msg = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error</strong> Form can not be submitted.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>';
                }
    ...
    <div class="container">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="lesson_name" name="lesson_name" aria-describedby="emailHelp">
            </div>
            <div class="form-floating">
                <textarea class="form-control" placeholder="Leave a comment here" id="lesson_desc" name="lesson_desc"></textarea>
